...
public class CharacterMovement : MonoBehaviour {
    ...
    void Update () {
        ...
        //Ends game if player reaches door
    ...
    private void LateUpdate()
    {
        ...
        if (!isDead && Vector3.Distance(transform.position, door.transform.position) > 2f) // Moving camera with body
        {
